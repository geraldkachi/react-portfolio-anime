...
import { faGithub, faInstagram, faLinkedin, faSkype, faUber, faYoutube } from "@fortawesome/free-brands-svg-icons"
  ...
  return (
    <div className="nav-bar">
      <Link className="logo" to="/">
        ...
        <span className="sub-logo" style={{
          textAlign: 'right', color: '#ffd700',
          // fontSize: '22px',
          display: 'block',
          lineHeight: '51px',
          height: '51px',
      ...
      <ul>
        ...
        <li>
          <a href="https://www.youtube.com/channel/UCa42saTlKHeOfegmZGpQPPw" rel="noreferrer" target="_blank">
        ...
        <li>
          <a href="https://instagram.com/geraldkachi" rel="noreferrer" target="_blank">
